...
<div id="update" class="w3-modal">
  ...
  <form action="./" method="post">
            ...
            <label class="w3-text-blue"><b>harga beli</b></label>
            <input class="w3-input w3-border focus" type="text" min="1" id="data5" name="data55">
            <label class="w3-text-blue"><b>harga jual</b></label>
            <input class="w3-input w3-border focus" type="text" min="1" id="data6" name="data66">
...
function updateFunc(d1, d2, d3,d4 , d5, d6){
    ...
    document.getElementById('data6').value= d6;
